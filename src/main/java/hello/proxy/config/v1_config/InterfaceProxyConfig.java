...
import hello.proxy.config.v1_config.interface_proxy.OrderControllerInterfaceProxy;
import hello.proxy.config.v1_config.interface_proxy.OrderRepositoryInterfaceProxy;
import hello.proxy.config.v1_config.interface_proxy.OrderServiceInterfaceProxy;
